...
var ASM_CONSTS = {
 ...
 107978: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108046: () => { document.exitFullscreen(); },  
 108073: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108146: () => { if (document.fullscreenElement) return 1; },  
 108192: () => { return document.getElementById('canvas').width; },  
 108244: () => { return screen.width; },  
 108269: () => { document.exitFullscreen(); },  
 108296: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108429: () => { return window.innerWidth; },  
 108455: () => { return window.innerHeight; },  
 108482: () => { if (document.fullscreenElement) return 1; },  
 108528: () => { return document.getElementById('canvas').width; },  
 108580: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108648: () => { if (document.fullscreenElement) return 1; },  
 108694: () => { return document.getElementById('canvas').width; },  
 108746: () => { return screen.width; },  
 108771: () => { return window.innerWidth; },  
 108797: () => { return window.innerHeight; },  
 ...
 108947: () => { document.exitFullscreen(); },  
 108974: () => { if (document.fullscreenElement) return 1; },  
 109020: () => { return document.getElementById('canvas').width; },  
 109072: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109140: () => { document.exitFullscreen(); },  
 109167: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 109225: () => { return screen.width; },  
 109250: () => { return screen.height; },  
 109276: () => { return window.screenX; },  
 109303: () => { return window.screenY; },  
 109330: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 109383: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 109454: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 109511: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 109767: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
