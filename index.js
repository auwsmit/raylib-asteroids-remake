...
var ASM_CONSTS = {
 ...
 107850: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107918: () => { document.exitFullscreen(); },  
 107945: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108018: () => { if (document.fullscreenElement) return 1; },  
 108064: () => { return document.getElementById('canvas').width; },  
 108116: () => { return screen.width; },  
 108141: () => { document.exitFullscreen(); },  
 108168: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108301: () => { return window.innerWidth; },  
 108327: () => { return window.innerHeight; },  
 108354: () => { if (document.fullscreenElement) return 1; },  
 108400: () => { return document.getElementById('canvas').width; },  
 108452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 108643: () => { return window.innerWidth; },  
 108669: () => { return window.innerHeight; },  
