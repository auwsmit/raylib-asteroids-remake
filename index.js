...
var ASM_CONSTS = {
 ...
 111846: () => { return document.getElementById('canvas').width; },  
 111898: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111966: () => { document.exitFullscreen(); },  
 111993: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 112066: () => { if (document.fullscreenElement) return 1; },  
 112112: () => { return document.getElementById('canvas').width; },  
 112164: () => { return screen.width; },  
 112189: () => { document.exitFullscreen(); },  
 112216: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 112349: () => { return window.innerWidth; },  
 112375: () => { return window.innerHeight; },  
 112402: () => { if (document.fullscreenElement) return 1; },  
 112448: () => { return document.getElementById('canvas').width; },  
 112500: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112568: () => { if (document.fullscreenElement) return 1; },  
 112614: () => { return document.getElementById('canvas').width; },  
 112666: () => { return screen.width; },  
 112691: () => { return window.innerWidth; },  
 112717: () => { return window.innerHeight; },  
